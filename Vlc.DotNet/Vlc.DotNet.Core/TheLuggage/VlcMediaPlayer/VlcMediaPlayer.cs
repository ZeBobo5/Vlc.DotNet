...
namespace Vlc.DotNet.Core.TheLuggage
{
    public sealed partial class VlcMediaPlayer : IDisposable
    {
        ...
        public VlcMediaPlayer(DirectoryInfo vlcLibDirectory)
            : this(VlcTheLuggageManager.GetInstance(vlcLibDirectory))
        {
        }

        internal VlcMediaPlayer(VlcTheLuggageManager manager)
        {
        ...
        internal VlcTheLuggageManager Manager { get; private set; }
